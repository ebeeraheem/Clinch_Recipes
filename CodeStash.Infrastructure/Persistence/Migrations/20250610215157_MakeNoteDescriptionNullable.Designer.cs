...
namespace CodeStash.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250610215157_MakeNoteDescriptionNullable")]
    partial class MakeNoteDescriptionNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CodeStash.Domain.Entities.AuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CodeStash.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.Property<bool>("IsSocialLinksPublic")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("CodeStash.Domain.Entities.Note", b =>
                {
                    b.HasOne("CodeStash.Domain.Entities.ApplicationUser", "Author")
                        .WithMany()
            ...
            modelBuilder.Entity("NoteTag", b =>
                {
                    b.HasOne("CodeStash.Domain.Entities.Note", null)
                        .WithMany()
                        .HasForeignKey("NotesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CodeStash.Domain.Entities.Tag", null)
                        .WithMany()
